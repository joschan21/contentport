...
const findFuzzyMatches = (text: string, keywords: string[], tolerance: number = 1): HighlightMatch[] => {
...
export const highlightText = (text: string, keywords: string[]): (string | React.ReactElement)[] => {

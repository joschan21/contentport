...
const LoginPage = () => {
  ...
  const renderChildren = () => {
    if (errorMsg) {
      return (
        <div className="w-full border-4 border-destructive border-dashed flex flex-col relative items-center gap-3 max-w-xl bg-white z-10 shadow-xl rounded-2xl  py-10 px-3 md:px-12">
